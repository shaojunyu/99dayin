        ...
        <div class="content">
            ...
            <div class="left-part authentic-page">
             ...
             <div class="left-part change-ps">
                ...
                <div class="ps-input"><input type="password"><span>旧密码:</span></div>
                <div class="ps-input"><input type="password"><span>新密码:</span></div>
                <div class="ps-input"><input type="password"><span>再次确认:</span></div>
                <div class="basic-btn">
                    <button>取消</button>
                    <button>确认</button>
                </div>
