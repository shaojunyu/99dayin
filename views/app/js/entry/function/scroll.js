define(['jquery'], function($) {
    ...
    function ScrollPage(opts) {
        var _this = this;
        this.opts = $.extend({}, ScrollPage.DEFAULT, opts);
    ...
    ScrollPage.prototype.moveUp = function() {
        index -= 1;
        loca += sec_height;
        this.init(loca);
    }
    ScrollPage.prototype.moveDown = function() {
            index += 1;
            loca -= sec_height;
            this.init(loca);
        }
    ...
    //缓动元素位置
    ScrollPage.prototype.init = function(loca) {
