...
require([
    ...
    'prompt',
    'utility'
], function ($, validate, Encryption, prompt) {
    ...
    var Pathurl = {
        ...
        confirm: Encryption.Encryption('./index.php/api/resetPassword'),
    ...
    var confirm = {
        ...
        init: function init() {
            ...
            $('.getCode').on('click', function () {
                var $this = $(this), phone = _this.phone.val().trim();
            ...
            this.confBth.on('click', function () {
                var phone = confirm.phone.val().trim(), code = confirm.code.val().trim(), newPs = confirm.newPs.val().trim(), _this = this;
