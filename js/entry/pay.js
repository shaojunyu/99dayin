...
require(['encryption'], function (encryption) {
    ...
    function ajax() {
        var url = encryption.Encryption('../index.php/api/isPaid'), chargeId = document.querySelector('.pay_bill_value').innerHTML, xhr = new XMLHttpRequest(), data;
        ...
        xhr.send(JSON.stringify({ chargeId: chargeId }));
    }
    ;
    setTimeout(function () {
        ajax();
...
define('../js/entry/pay', ['encryption'], function () {
    return;
});