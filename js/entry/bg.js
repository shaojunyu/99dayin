...
require(['jquery', 'iscroll'], function ($, scroll) {
    var SelfSelect = {
        ...
        //替换选择的内容
        replaceText: function replaceText($target, $replace) {
        ...
        toggleClass: function toggleClass($ele, classname) {
            $ele[0].classList.toggle(classname);
        },
        bindClick: function bindClick(btn, ul) {
            var _this = this;
