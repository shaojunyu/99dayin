...
require([
    ...
    var Pathurl = {
        ...
        delete: Encryption.Encryption('../index.php/api/deleteCartItem')
    };
    ...
    var PayBill = {
        ...
        init: function init() {
            ...
            this.checkout.on('click', function () {
                var _this2 = this;
                var method = $('input[name="method"]:checked').val(), totle = $('.total-price').html(), info = {};
                if (method == null || method == '') {
                    ...
                    if (method === '到店自取') {
                        ...
                        var address = $('.address').val().trim(), area = $('.school-area').val(), build = $('.building').val();
