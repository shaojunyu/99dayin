...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (factory) {
		...
		browser.ie6 = browser.msie && /msie 6./.test(ua) && _typeof(window['XMLHttpRequest']) !== 'object';
	  ...
	  */
	   ...
	   */
			init: function init(data, options) {
				...
				if ((typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object') {
					...
					alert('SimpleModal Error: Unsupported data type: ' + (typeof data === 'undefined' ? 'undefined' : _typeof(data)));
					return s;
				}
	   ...
	   */
			update: function update(height, width) {
				var s = this;
			...
			setContainerDimensions: function setContainerDimensions() {
				var s = this,
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(6), __webpack_require__(8)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($, prompt) {
		Enroll.DEFAULT = {
			reg: [], //获取正则表达式
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(10)], __WEBPACK_AMD_DEFINE_RESULT__ = function (md5) {
		/*
	  * 加密算法
	  */
